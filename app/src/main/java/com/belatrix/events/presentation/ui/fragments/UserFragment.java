...
import com.belatrix.events.presentation.presenters.UserPresenter;
...
public class UserFragment extends BelatrixBaseFragment implements UserPresenter.View {
    ...
    public static Fragment create(Context context) {
        ...
        return Fragment.instantiate(context, UserFragment.class.getName(), args);
    }
    ...
    protected void initDependencies(UIComponent applicationComponent) {
        applicationComponent.inject(UserFragment.this);
        mPresenter.setView(UserFragment.this);
    }
